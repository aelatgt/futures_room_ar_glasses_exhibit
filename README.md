...
3. The glasses.blend and the glasses.glb files are for the 3D model of the glasses, which was edited so that it could be successfully imported into the A-Frame scene. The original_glasses.blend file is for the original 3D model of the glasses. See the to-do below. 
